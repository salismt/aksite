...
angular.module('aksiteApp')
    .controller('MainCtrl', function ($scope, $http, socket, d3Service) {
		...
		var image = new Image;
		image.src = "/assets/images/ex.jpg";
		...
		function resized() {
			...
			anchor.enter().append("a")
				.attr("xlink:href", function(d) { return d.photo.url; })
				.attr("xlink:title", function(d) { return d.photo.title; })
				.append("path")
        ...
        var svg = d3.select("#featured-photos").append("svg")
